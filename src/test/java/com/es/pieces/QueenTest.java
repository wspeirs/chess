...
public class QueenTest {
    ...
    public void testGenMovesSinglePiece() {
        Queen q = new Queen(Color.WHITE, board, 0x33);
    ...
    public void testGenMovesAllCaptures() {
        Queen b = new Queen(Color.WHITE, board, 0x33);
    ...
    public void testGenMovesLowerLeftCorner() {
        Queen b = new Queen(Color.WHITE, board, 0x00);
    ...
    public void testGenMovesLowerRightCorner() {
        Queen b = new Queen(Color.WHITE, board, 0x07);
    ...
    public void testGenMovesUpperLeftCorner() {
        Queen b = new Queen(Color.WHITE, board, 0x70);
    ...
    public void testGenMovesUpperRightCorner() {
        Queen b = new Queen(Color.WHITE, board, 0x77);
